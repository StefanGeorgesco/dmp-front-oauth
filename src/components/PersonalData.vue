...
<template>
  <div class="row justify-content-center pt-3">
    <div class="col-sm-10 col-md-9 col-lg-7 col-xxl-5">
      <div class="row">
        <h1 id="top" class="h2">Données personnelles</h1>
      </div>
      <form @submit.prevent="submitUpdateFile" class="row mb-3 g-2 pt-3 needs-validation justify-content-center" novalidate autocomplete="off">
        ...
        <div class="col-8 col-sm-6 col-md-5 g-0">
          <div class="vstack gap-2 mt-4">
            <button v-if="update" class="btn btn-primary d-flex align-items-center justify-content-center py-2" type="submit">
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-check me-1"
                viewBox="0 0 16 16">
                <path
            ...
            <a v-if="update" role="button" @click="init"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x me-1"
                viewBox="0 0 16 16">
                <path
            ...
            <a v-if="!update" role="button" @click="updateStart"
              class="btn btn-primary d-flex align-items-center justify-content-center py-2" style="padding: 0.75rem 0;">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil me-2"
                viewBox="0 0 16 16">
                <path
            ...
            <RouterLink to="/main" class="btn btn-outline-secondary d-flex align-items-center justify-content-center py-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-backspace me-2"
                viewBox="0 0 16 16">
                <path
